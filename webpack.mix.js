...
mix.copy(AdminEShopResourcesPath+GorlabsAssets+'js/plugin/data-tables/css/images',AdminEShopPublicPath+'gorlabs/css/image');
...
mix.js('resources/js/app.js',AdminEShopPublicPath+ 'gorlabs/js')
    ...
    .styles([
        ...
        AdminEShopResourcesPath+GorlabsAssets+'flag-icon/css/flag-icon.css'

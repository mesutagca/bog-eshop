<!DOCTYPE html>
<html lang="en">
@include('themes.admins.e-shop.gorlabs.partials.head')
<body>
<div class="wrapper">
    <div class="main-header">
        ...
        <!-- Navbar Header -->
@include('themes.admins.e-shop.gorlabs.partials.nav-bar')
        <!-- End Navbar -->
    </div>
    <!-- Sidebar -->
@include('themes.admins.e-shop.gorlabs.partials.sidebar')
    <!-- End Sidebar -->
    <div class="main-panel">
        <div class="content">
@yield('content')
        </div>
        @include('themes.admins.e-shop.gorlabs.partials.footer')
    </div>

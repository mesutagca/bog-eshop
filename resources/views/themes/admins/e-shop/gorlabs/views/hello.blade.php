                                ...
                                <div class="table-responsive table-hover table-sales">
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flag">
                                                    <img src="{{asset('themes/admins/e-shop/gorlabs/img/flags/id.png')}}" alt="indonesia">
                                                </div>
                                            </td>
                                            <td>Indonesia</td>
                                            <td class="text-right">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flag">
                                                    <img src="{{asset('themes/admins/e-shop/gorlabs/img/flags/us.png')}}" alt="united states">
                                                </div>
                                            </td>
                                            <td>USA</td>
                                            <td class="text-right">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flag">
                                                    <img src="{{asset('themes/admins/e-shop/gorlabs/img/flags/au.png')}}" alt="australia">
                                                </div>
                                            </td>
                                            <td>Australia</td>
                                            <td class="text-right">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flag">
                                                    <img src="{{asset('themes/admins/e-shop/gorlabs/img/flags/ru.png')}}" alt="russia">
                                                </div>
                                            </td>
                                            <td>Russia</td>
                                            <td class="text-right">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flag">
                                                    <img src="{{asset('themes/admins/e-shop/gorlabs/img/flags/cn.png')}}" alt="china">
                                                </div>
                                            </td>
                                            <td>China</td>
                                            <td class="text-right">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flag">
                                                    <img src="{{asset('themes/admins/e-shop/gorlabs/img/flags/br.png')}}" alt="brazil">
                                                </div>
                                            </td>
                                            <td>Brasil</td>
                                            <td class="text-right">
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body pb-0">
                        <div class="d-flex">
                            <div class="avatar">
                                <img src="{{asset('themes/admins/e-shop/gorlabs/img/logoproduct.svg')}}" alt="..."
                        ...
                        <div class="d-flex">
                            <div class="avatar">
                                <img src="{{asset('themes/admins/e-shop/gorlabs/img/logoproduct3.svg')}}" alt="..."
                                     class="avatar-img rounded-circle">
                            </div>
                            <div class="flex-1 pt-1 ml-2">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="card-list">
                            <div class="item-list">
                                <div class="avatar">
                                    <img src="{{asset('themes/admins/e-shop/gorlabs/img/jm_denis.jpg')}}" alt="..."
                                         class="avatar-img rounded-circle">
                                </div>
                            ...
                            <div class="item-list">
                                <div class="avatar">
                                    <img src="{{asset('themes/admins/e-shop/gorlabs/img/chadengle.jpg')}}" alt="..."
                                         class="avatar-img rounded-circle">
                                </div>
                                <div class="info-user ml-3">
                            ...
                            <div class="item-list">
                                <div class="avatar">
                                    <img src="{{asset('themes/admins/e-shop/gorlabs/img/talha.jpg')}}" alt="..." class="avatar-img rounded-circle">
                                </div>
                                <div class="info-user ml-3">
                            ...
                            <div class="item-list">
                                <div class="avatar">
                                    <img src="{{asset('themes/admins/e-shop/gorlabs/img/mlane.jpg')}}" alt="..." class="avatar-img rounded-circle">
                                </div>
                                <div class="info-user ml-3">
